    ...
    <div className='flex-1 flex justify-between items-center gap-2 max-lg:flex-col max-lg:text-center'>
      <div>
        ...
        <ConfigProvider theme={{ token: { colorPrimary: '#00b96b', }, }}>
          <a href='https://wa.me/970567201715?text=' target='_blank' rel="noreferrer">
      ...
      <div className='text-center'>
        ...
        <img
          src='https://chart.googleapis.com/chart?chs=200x200&cht=qr&chl=https://wa.me/970567201715?text='
          alt='qr code'
